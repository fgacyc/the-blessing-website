...
const AboutUsContent = () => {
  ...
  return (
    <section className={`relative z-10 bg-white overflow-y-hidden overflow-x-hidden`} ref={containerRef}>
      {/* Logo */}
      {/* FIRST SECTION */}
      <motion.div
        ref={ref}
      ...
      <div className={`grid ${isMobile ? "grid-cols-1 pt-22 pb-14" : "grid-cols-3 py-22"}  bg-[#fffcf8]   space-y-10 `}>
        <motion.div
          ref={vmaMotion}
        ...
        <motion.div
          ...
          transition={{ type: "spring", duration: 0.6, ease: "easeOut", delay: 0.3 }}
          className="flex flex-col justify-center py-10 items-center">
          <img src="/aboutUs/aboutUs-mission.png" alt="mission" className={`${isMobile ? "w-1/2 h-5/6" : "w-72 h-42"} `} />
          <h2 className={`text-black font-bold text-center my-6 text-[1.1rem]`} style={{ letterSpacing: "0.2rem" }}>
            {" "}
            在教会以外，引导人
            <br />
        ...
        <motion.div
          ...
          transition={{ type: "spring", duration: 0.6, ease: "easeOut", delay: 0.6 }}
          className="flex flex-col justify-center my-4 items-center ">
          <img
            src="/aboutUs/aboutUs-action.png"
            alt="mission"
            className={`${isMobile ? "w-1/2 h-5/6 mt-3" : "w-72 h-42 -translate-y-11"} `}
          />
          <h2
            className={`text-black font-bold text-center  text-[1.1rem] ${isMobile ? "my-6" : "-translate-y-4"}`}
      ...
      {/* 加入我们 Section */}
      <div className={`${isMobile ? "" : "py-20"} flex bg-black justify-center py-15 `}>
