  ...
  return (
    <section className={`relative z-10  bg-white`}>
      ...
      <div className="relative w-full  ">
        ...
        {isMobile ? (
          <video key="mobile" playsInline autoPlay webkit-playsinline="true" muted loop id="myVideo">
      ...
      <motion.div
        ...
        <img src="/locations/Location Pg1-Puchong.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg2-Sri Petaling.jpg" alt="TB" className={imageBaseClasses} />

        <img src="/locations/Location Pg3-Sg Wang.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg4-Kepong.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg5-Cheras.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg6-USJ.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg7-TRX.jpg" alt="TB" className={imageBaseClasses} />

        <img src="/locations/Location Pg8-Kuantan.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg9-Muar.jpg" alt="TB" className={imageBaseClasses} />
      </motion.div>
      ...
      <motion.div
        ...
        id="westMalaysiaImg"
        className={`grid grid-cols-2 gap-0 ${isMobile ? "px-5" : "px-10"}`}>
        <img src="/locations/Location Pg10-Sibu.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg11-KK.jpg" alt="TB" className={imageBaseClasses} />
      </motion.div>
      ...
      <motion.div
        ...
        id="westMalaysiaImg"
        className={`grid grid-cols-2 gap-0 ${isMobile ? "px-5" : "px-10"}`}>
        <img src="/locations/Location Pg13-HK.jpg" alt="TB" className={imageBaseClasses} />
        <img src="/locations/Location Pg12-Singapore.jpg" alt="TB" className={imageBaseClasses} />
      </motion.div>
    </section>
  );
};
