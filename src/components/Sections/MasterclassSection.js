  ...
  return (
    <section id="masterclass" className="min-h-screen bg-black py-16 lg:py-24">
      <Container>
        ...
        <div
          className={`bg-gradient-to-b from-white/5 to-white/15 backdrop-blur-[24px] rounded-lg p-6 lg:p-8 border border-gray-700/50 max-w-6xl mx-auto relative overflow-hidden ${
            !isMobile
              ? "bg-[url('/glow-bg.png')] bg-no-repeat bg-center bg-cover"
              : ""
          }`}
        >
          {/* Section Header */}
          <div className="text-center mb-10 lg:mb-14 ">
            ...
            <h2
              ...
              } font-bold mb-4 text-orange-400`}
            >
              MASTERCLASS 大师课
            </h2>
            <p className="text-lg lg:text-xl mb-3 text-white">
              从高效执行者，跃升为系统掌局者
            </p>
            <p className="text-sm lg:text-base max-w-2xl mx-auto whitespace-pre-line text-white">
              不是更拼命，而是更有策略。{"\n"}
              不是更聪明，而是更对齐神的心意。{"\n"}
              将带你从“做事的人”，成为“设局的人”。
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {masterclassData.map((mc) => (
              <div
                key={mc.id}
                className="bg-gradient-to-b from-white/5 to-white/15 backdrop-blur-[24px] rounded-lg p-6 border border-gray-700/50 flex flex-col"
              >
                ...
                <h4 className="text-white text-xs mt-2 mb-1">{mc.question}</h4>
