...
const Footer = () => {
  ...
  return (
    <section
      className={`relative z-10  overflow-y-hidden  overflow-x-hidden bg-black`}
      ref={containerRef}
    >
        ...
        <div>
          <img
            ...
            className={`${imageBaseClasses} ${
              isMobile ? " h-[500px] w-auto object-cover " : ""
            }  overflow-x-hidden  opacity-70`}
          />
        </div>
        <div
          className={`${
            isMobile ? "w-3/4 mt-4 -translate-x-3/6" : "-translate-x-1/2 "
          } absolute top-3/5 left-1/2  -translate-y-1/2`}
        >
          ...
          <div
            className={`${
              isMobile
                ? "flex space-x-4 mt-5 translate-x-3  min-w-max"
                : "flex space-x-10 mt-5 w-full "
            }`}
          >
            <button
              className={`${
                isMobile ? "w-14 h-8 text-[0.6rem] " : "w-52 h-16 "
          ...
          <div
            className={`${
              isMobile
                ? "flex space-x-5 justify-center mt-3 min-w-max"
          ...
          >
            <a
              ...
              } pi pi-instagram  transform duration-300 ease-out hover:scale-105 text-red-700 bg-white animate-bounce rounded-lg p-3`}
            ></a>
            <a
              href="http://facebook.com/fgatheblessing"
              className={`${
                isMobile ? "text-[2.3rem] scale-65" : "text-[3rem]"
              } pi pi-facebook  transform duration-300 ease-out hover:scale-105 text-blue-700 bg-white  animate-bounce rounded-lg p-3`}
            ></a>
          </div>
        </div>
      </div>
